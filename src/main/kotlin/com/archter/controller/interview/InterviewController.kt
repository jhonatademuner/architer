package com.archter.controller.interview
...
import com.archter.service.interview.InterviewService
...
class InterviewController(
    ...
    @PostMapping("/v1/interview/{interviewId}/message")
    fun sendMessage(@PathVariable interviewId: UUID, @RequestBody message: InterviewMessageCreateDTO) : ResponseEntity<InterviewMessageDTO> {
        return ResponseEntity.status(HttpStatus.OK).body(interviewService.sendMessage(interviewId, message))
    }
