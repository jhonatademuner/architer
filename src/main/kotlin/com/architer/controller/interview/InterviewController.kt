...
class InterviewController(
    ...
    @GetMapping("/v1/interviews/{interviewId}/messages")
    fun findMessagesByInterviewId(@PathVariable interviewId: UUID): ResponseEntity<List<InterviewMessageDTO>> {
        return ResponseEntity.ok(interviewService.findMessagesByInterviewId(interviewId))
    }
